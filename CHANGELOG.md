...
### Değiştirildi
* Açılış logosu ve NoX yazısı birlikte büyütüldü (imageWidth: 280).
...
* Katkı, destek, güvenlik ve davranış kuralları NoX Finance'e uyarlandı; GitHub Actions, Dependabot ve ESLint yapılandırmaları mobil uygulamaya göre düzenlendi.
