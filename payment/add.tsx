...
const QUICK_ICONS = [
  'cash', 'flash', 'home', 'car', 'cart', 'phone',
  'wifi', 'television', 'medical-bag', 'school', 'airplane',
  'dumbbell', 'music', 'coffee', 'food', 'bank',
  'credit-card', 'gift', 'heart', 'star', 'gamepad', 'book',
];
            ...
            {activeIconTab === 'icon' ? (
              ...
              <View style={styles.emojiInputSection}>
                ...
                <TextInput
                  ...
                  placeholderTextColor={Colors.textMuted}
                  maxLength={2}
                  style={{ fontSize: 36, textAlign: 'center', color: Colors.textPrimary, backgroundColor: Colors.surfaceLight, borderRadius: BorderRadius.md, padding: 16, marginVertical: 12 }}
                />
